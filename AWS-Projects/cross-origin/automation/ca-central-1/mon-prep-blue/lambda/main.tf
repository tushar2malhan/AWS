module "lambda_builder" {
  ...
  lambda_timeout            = "300"
  account_id                = "550629512586"
  yellow_account_id         = "291925875877"
  grey_account_id           = "332318758586"
  blue_account_id           = "550629512586"
  cross_account_id          = "550629512586"
  config_file_key           = "paysafe-upf-dataops-lambda-emr-details-audit-trail/prep/blue/flag-execute-lambda.json"  
}
